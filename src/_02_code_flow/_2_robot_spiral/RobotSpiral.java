...
public class RobotSpiral {
	...
	public static void main(String[] args) {
		...
		// Create a new Robot
		Robot mango = new Robot();

		// Set your robot's pen down
		mango.penDown();
		// SPEED. Set the robot to go at max speed (100)
		mango.setSpeed(100);
		// COUNT. Create an int variable that will count how many lines of the spiral we
		// have drawn.
		// Start its value as zero.
		int count = 0;
		// LOOP. Start a while loop to repeat the COLOR, DRAW, TURN, and COUNT code
		// below until 50 lines have been drawn
		while (count < 50) {
